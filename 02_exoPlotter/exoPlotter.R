...
# This script takes the 'output_prefix' form 5primeCounter.py script
# as input argument and plots the 5'coverage profile of exo-reads around
# centered sequence motifs and some others.
#
#
#
# Usage:
#
# Rscript exoPlotter.R <output_prefix_of_exo-profiler.py>
#
#
# 15.10.13 by Jonas Ibn-Salem <ibnsalem@molgen.mpg.de> 
# with some parts adapted from Mike Love and Morgane Thomas-Chollier
